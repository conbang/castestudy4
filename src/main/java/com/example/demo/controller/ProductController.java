...
public class ProductController {
    ...
    //    @GetMapping("/minus/{id}")
//    public ResponseEntity<Product> minusToCart(@PathVariable Long id, @ModelAttribute("cart") Cart cart) {
//        Optional<Product> productOptional = productService.findById(id);
//        if (!productOptional.isPresent()) {
//            return new ResponseEntity<>(HttpStatus.NO_CONTENT);
//        }
...
//    public ResponseEntity<Product> deleteCart(@PathVariable Long id, @ModelAttribute("cart") Cart cart) {
//        Optional<Product> productOptional = productService.findById(id);
//        if (!productOptional.isPresent()) {
//            return new ResponseEntity<>(HttpStatus.NO_CONTENT);
//        }
